...
<body>
    ...
    <div class="box">
     <table  style =" font-size:16pt"  align="center" width="100%" height="100%">
        <tr>
          <td style="color:white"><h1 align="center"><marquee><i>Welcome To KPT online Library System</i>  </marquee></h1></td>
        </tr>
        <tr>
      ...
      <div class="nav">
        <ul>
          ...
          <li><a style="background-color: green" href="index.php">LOGIN</a>
          </li>
...
:20%;background:rgba(0, 0, 0, 0.5);box-shadow:0px 0px 20px white;border-radius:10px;padding:3%;font-size:15px">This project is the prototype of a Simple Library Management System. Librarian has a provision to add book details like ID number, book title, author name, through the web page. In addition to this, librarian or any user has a provision to search for the available books in the library by the book id or book Name. If book details are present in the database, the search details are displayed on the web page.Student can request the librarian  for getting the book via this web.Student can easily download this book's E-Book which is PDF file.</P>
      ...
      <P style="color:white;text-align:center;width:60%;font-weight:bold;margin-left
                :20%;background:rgba(0, 0, 0, 0.5);box-shadow:0px 0px 20px red;border-radius:10px;padding:3%;font-size:15px">We would like to express our special thanks of gratitude to our teacher <i>Geetha ma'am</i> who gave us the golden opportunity to do this wonderful project on the topic : ONLINE LIBRARY MANAGEMENT SYSTEM using  PHP, which also helped us indoing a lot of Research and we came to know about so many new things we are really thankful to her.
</P>
...
:30%;background:rgba(0, 0, 0, 0.5);box-shadow:0px 0px 20px #fc7af7;border-radius:10px;padding:3%;font-size:15px;height:200px;"><marquee direction="up" scrolldelay="200" >
         ...
         <tr><td><br/></td><td>1. PRATHAM U  </td><td><br/></td><td> 
         <br>Mail-ID : prathamu4@gmail.com</td><td><br/></td></tr>
            
            <br/>
            <hr>
          
          
         <tr><td><br/></td><td>2. GAGAN SHETTY</td><td><br/></td><td><br>Mail-ID : gaganshetty@gmail.com</td><td><br/></td></tr>
            
            <br/>
            <hr>
          
          
           <tr><td><br/></td><td>3. JOSTON R </td><td><br/></td><td><br>Mail-ID : joston@gmail.com </td><td><br/></td></tr>
            
            <br/>
            <hr>
          
          
           <tr><td><br/></td><td>4. SATHWIK </td><td><br/></td><td><br>Mail-ID :  sathwik@gmail.com</td><td><br/></td></tr>
            
            <br/>
            <hr>
          
          
           <tr><td><br/></td><td>5. GAUTHAM</td><td><br/></td><td><br>Mail-ID : gautham@gmail.com</td><td><br/></td></tr>
